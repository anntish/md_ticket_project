...
Проект собирается и запускается полностью через Docker Compose и хранит свою бизнес-логику в сервисе FastAPI (`app/`). Ниже собраны инструкции по запуску, подключению pre-commit и конфигурации окружения.
